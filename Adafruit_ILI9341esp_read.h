...
class Adafruit_ILI9341 : public Adafruit_GFX {
 ...
 public:
  ...
  void     begin(void),
           ...
           setAddrWindowOnly(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1),
  ...
  void writeRow(uint16_t *colors, int16_t y); // 16bpp
  void writeBlock(uint16_t *colors,
 ...
 private:
  ...
  inline void setAddrWindowOnly_(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1);
#else
  ...
  void setAddrWindowOnly_(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1);
#endif
