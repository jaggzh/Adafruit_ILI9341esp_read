...
void Adafruit_ILI9341::setAddrWindowOnly(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
    spiCsLow();
    setAddrWindowOnly_(x0, y0, x1, y1);
    spiCsHigh();
}
...
void Adafruit_ILI9341::setAddrWindowOnly_(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
